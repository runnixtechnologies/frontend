...
export const MainHeader: FC = () => {
  ...
  return (
    <div className="w-full relative">
      <header className="w-full h-auto py-4 md:py-6 pl-4 pr-3 sm-md:px-6 lg:px-10 xl:px-16 flex items-center border-b border-transparent z-[20] dark:bg-[#1D192B] bg-white">
