...
export default function HowItWorksSection() {
  return (
    <section className="w-full relative dark:bg-[#161226] bg-white flex justify-center items-center py-10 lg:py-20 3xl:pb-30 px-4 2:px-0">
      <div
      ...
      >
        <div className="w-full flex flex-col gap-12">
          <div className="w-full flex justify-between items-center">
            <h2 className="w-full text-center xl:text-left font-figtree font-bold text-xl sm:text-2xl md:text-3xl xl:text-4xl 2xl:text-[48px]/[120%] dark:text-white text-black">
              How Runnix Works
            </h2>
            <GetStartedButton buttonText="Get the App" link="/" />
          </div>
