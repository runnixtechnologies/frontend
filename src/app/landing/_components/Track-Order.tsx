  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="w-[90px] h-[28px] xs:w-[100px] xs:h-[30px] sm:w-[110px] py-1 px-2 xs:px-3 flex gap-[6px] xs:gap-[10px] font-normal font-figtree text-[14px] xs:text-[16px]/[100%] text-white tracking-normal rounded-[30px] xs:rounded-[36px] bg-[#FF875C] hover:bg-[#FF875C]/80 items-center">
          Track Order
        </Button>
      </DialogTrigger>
      <DialogContent className="bg-white dark:bg-[#161226] w-[calc(100%-24px)] max-w-[90vw] xs:max-w-[85vw] md:max-w-[640px] h-auto max-h-[90vh] xs:max-h-[85vh] sm:max-h-[650px] overflow-y-auto grid grid-cols-1 py-[24px] xs:py-[32px] sm:py-[40px] md:py-[48px] px-[16px] xs:px-4 md:px-[24px] gap-[16px] xs:gap-[20px] sm:gap-[24px] rounded-[20px] xs:rounded-[28px] sm:rounded-[37px] border-l-[1px] border-t-[1px] border-b-[2px] xs:border-b-[3px] sm:border-b-[4px] border-r-[2px] xs:border-r-[3px] sm:border-r-[4px] dark:shadow-[0px_22px_49px_0px_#0000001A] shadow-[0px_12px_30px_0px_#0000001A] xs:shadow-[0px_16px_40px_0px_#0000001A] lg:shadow-[0px_22px_49px_0px_#0000001A]">
        <DialogTitle />
        <DialogClose className="absolute right-2 xs:right-4 top-2 xs:top-6 md:top-4 dark:bg-[#161226] bg-white flex justify-center items-center cursor-pointer z-10">
        ...
        <div className="w-full flex flex-col gap-[16px] xs:gap-[20px] sm:gap-[24px] justify-center items-center">
          ...
          <div className="w-full flex flex-col gap-[20px] xs:gap-[28px] sm:gap-[36px]">
            <div className="w-full flex flex-col justify-center items-center gap-1 xs:gap-2">
              <h4 className="font-figtree font-bold text-[24px] sm:text-[28px] md:text-[40px]/[120%] tracking-[2%] text-center dark:text-white text-[#232323]">
                Track your Order
              </h4>
              <p className="font-figtree font-normal dark:text-[#DCDCDC] text-[#636066] text-sm md:text-base leading-[140%] -tracking-[2%] text-center">
