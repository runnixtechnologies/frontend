...
const data: OfferProps[] = [
  {
    ...
    description:
      "Join the Runnix platform and complete our onboarding process.",
  },
  {
    id: 2,
    title: "Get Delivery Requests",
    description: "Accept jobs that match your availability and location.",
  },
  {
    id: 3,
    title: "Pick Up & Deliver",
    description: "Follow the app's guidance for pickup and drop-off.",
  },
  {
    id: 4,
    title: "Earn Instantly",
    description: "Get paid directly after successful deliveries.",
  },
]

const images: string[] = [
  "/images/rider-howitworks_1.webp",
  "/images/rider-howitworks_2.webp",
  "/images/rider-howitworks_3.webp",
  "/images/rider-howitworks_4.webp",
]
