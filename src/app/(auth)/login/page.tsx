...
export default function LoginPage() {
  ...
  return (
    <div className="w-full flex justify-center items-center">
      <div className="bg-white dark:bg-[#161226] w-full md:w-[480px] overflow-y-auto grid grid-cols-1 py-6 xs:py-[32px] sm:py-[40px] md:py-[48px] px-[16px] xs:px-4 md:px-6 gap-[16px] xs:gap-[20px] sm:gap-6">
                  ...
                  <div className="w-full flex flex-col gap-1">
                    ...
                    <div className="w-full flex justify-end items-end mt-2">
                      <Link
                        ...
                        className="font-medium font-figtree text-[16px]/[[120%]] -tracking-[2%] hover:underline hover:underline-offset-4"
                      >
                        Forget password
                      </Link>
                    </div>
