...
import { z } from "zod"
import SignupLayout from "./signupWrapper"
...
export default function UserSignupPage() {
  ...
  async function onSubmit(data: FormValues) {
    if (data) {
      router.push(`/otp?email=aishaidir94@gmail.com`)
    }
  }
      ...
      <div className="w-full flex justify-center items-center">
        <div className="bg-white w-full lg:w-[480px] overflow-y-auto grid grid-cols-1 py-6 xs:py-[32px] sm:py-[40px] md:py-[48px] px-[16px] xs:px-4 md:px-6 gap-[16px] xs:gap-[20px] sm:gap-6">
          ...
          <div className="w-full flex flex-col gap-[16px] xs:gap-[20px] sm:gap-6 justify-center items-center">
            <Button className="w-full h-[52px] hover:text-white flex gap-3 py-4 px-3 border border-[#E5E0F4] bg-[#F7F6FC] dark:bg-[#F7F6FC] rounded-xl font-figtree font-semibold text-[##232323] dark:text-[#232323] text-[[16px]/[120%] tracking-normal text-center align-middle cursor-pointer shadow-none">
