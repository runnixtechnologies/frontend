...
export default function PendingPackageInformation({
  selectedDelivery,
    ...
    <div className="w-full flex flex-col lg:flex-row h-full max-h-[85vh] overflow-y-auto justify-between">
      ...
      <div className="flex flex-col gap-6 lg:w-[488px]">
        ...
        <div className="flex justify-between items-start">
          ...
          <span className="h-[35px] font-figtree font-bold bg-[#FFE2D4] text-[#FF875C] px-3 py-2 rounded-xl text-base leading-[120%] -tracking-[2%]">
            Pending
          </span>
        </div>
        {/* Package details */}
