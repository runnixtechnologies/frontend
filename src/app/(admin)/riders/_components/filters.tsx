...
interface RiderFiltersProps {
  onFilterChange?: (filters: RiderFilterValues) => void
}

export function RiderFilters({ onFilterChange }: RiderFiltersProps) {
  ...
  const updateActiveFiltersCount = (currentFilters: RiderFilterValues) => {
    let count = 0
      ...
      <div className="flex flex-1 flex-col gap-4 sm:flex-row sm:items-center">
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle className="font-figtree">Filter Riders</DialogTitle>
            </DialogHeader>
