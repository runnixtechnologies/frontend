...
export type TabKey = "all" | "active" | "inactive" | "suspended"
...
export default function RiderTabs({
  ...
  const values: { id: TabKey; label: string; total: number }[] = [
    { id: "all", label: "All Users", total: tabCounts?.all ?? size },
    { id: "active", label: "Active", total: tabCounts?.active ?? size },
    { id: "inactive", label: "Inactive", total: tabCounts?.inactive ?? size },
    {
      id: "suspended",
      label: "Suspended",
