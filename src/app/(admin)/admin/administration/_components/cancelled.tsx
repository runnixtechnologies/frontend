...
export default function CancelledPackageInformation({
  selectedDelivery,
}: PackageProps) {
    ...
    <div className="w-full flex flex-col lg:flex-row h-full max-h-[85vh] overflow-y-auto justify-between">
      ...
      <div className="flex flex-col gap-6 lg:w-[488px]">
        ...
        <div className="flex justify-between items-start">
          ...
          <span className="h-[35px] bg-[#FFF1F1] text-[#F83B3B] px-3 py-2 rounded-xl  font-figtree font-bold text-base leading-[120%] -tracking-[2%]">
            Cancelled
          </span>
        </div>
        {/* Package details */}
      ...
      <div className="w-[360px] p-6 flex flex-col gap-5 pl-8 border-l border-[#EFEFEF]">
        {/* Order Details */}
        {selectedDelivery.deliveryType === "receive" && (
          <div className="flex flex-col gap-5">
            ...
            {selectedDelivery.items ? (
              selectedDelivery.items.map((item, index: number) => (
                <div key={index} className="flex items-start">
                  ...
                  <div className="flex-grow">
                    <div className="flex justify-between items-start">
                      ...
                      <p className="whitespace-nowrap font-bold font-figtree text-[18px]/[120%] tracking-normal text-[#232323]">
                        x{item.quantity}
                      </p>
                    </div>
                    <p className="text-[14px]/[120%] tracking-normal font-normal font-figtree text-[#3D3D3D]">
                      {item.price}
                    </p>
                  </div>
                </div>
              ...
              <div className="p-3 rounded-md">
                <div className="flex justify-between">
                  <p className="font-semibold font-figtree text-[12px]/[120%] tracking-normal text-[#232323]">
            ...
            {/* Selections */}
            {selectedDelivery.items?.[0]?.selections && (
              <div className="bg-[#F0EEF9] rounded-md p-3 flex flex-col gap-[8px]">
                <div className="flex justify-between border-b border-[#E5E0F4]">
                  <h4 className="font-bold font-figtree text-[12px]/[120%] text-[#464646] tracking-normal">
                    Selections
                  </h4>
                  <p className="text-[12px]/[120%] tracking-normal font-normal font-figtree text-[#525252]">
                    ₦5,120
                  </p>
                </div>
                <ul>
                  {selectedDelivery.items[0].selections.map((selection, i) => (
                    <li
                      key={i}
                      className="flex items-centerfont-figtree font-normal text-sm leading-[140%] tracking-normal text-[#232323]"
                    >
