...
import { useGetTopRidersQuery } from "@/lib/redux/api/dashboard"
...
export default function TopPerformingRidersTable({
  dateFrom,
  dateTo,
  limit,
}: Props) {
  const { data, isLoading, isError } = useGetTopRidersQuery({
    date_from: dateFrom,
    date_to: dateTo,
  })
